...
- **Interaktive Relationen:** Mit Klicks auf Relationen (z.B. `sells` oder `pays`) lässt sich einfach zwischen Klassen hin- und hernavigieren
...
Die aktuelle Softwaresrchitektur sollte bei Codereviews durch automatisch generierte Diagramme immer in Blick bleiben. Nicht nur der git diff.

### Schnelle Navigation zwischen Klassen
